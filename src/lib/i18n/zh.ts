...
export const zh = {
  ...
  recipe: {
    ...
    amount: '用量',
    substitute: '替换',
    substituteSameCategory: '同类',
    substituteFlavorMatch: '风味',
    steps: '步骤',
    tips: '小贴士',
  ...
  about: {
    ...
    metaTitle: '关于',
    metaDesc: 'HowToCook — AI 驱动的菜谱平台，535 道菜谱覆盖 10 大分类，支持 MCP 协议接口。',
    intro: 'HowToCook 是一个 AI 驱动的菜谱平台，为所有下厨的人提供精确、可执行的烹饪指南。',
    description1: '535 道菜谱，覆盖川、粤、鲁、湘等 10 大分类，支持按难度、时间、食材、辣度等多维度筛选。通过偏好学习系统，越用越懂你的口味。',
