...
COOKING_METHODS: dict[str, list[str]] = {
    ...
    "饮品": [
        "冰沙", "冻", "奶冻", "冰淇淋", "鸡尾酒", "莫吉托", "柠檬水", "茶",
        "可乐", "啤酒", "酒酿", "醪糟", "酸梅", "龟苓膏", "冰粉", "咖啡", "特调",
    ],
    "调味": [
        "糖醋", "咖喱", "葱烧", "蒜蓉", "蒜香", "鱼香", "酸辣", "麻辣",
        "椒盐", "椒麻", "照烧", "芥末", "蚝油", "黑椒", "豉汁", "腐乳",
        "宫保", "口水", "怪味", "陈皮", "麻婆",
        "油泼", "蒲烧", "葱油", "辣子", "香辣", "孜然", "咸蛋黄",
        "拔丝", "反沙",
    ],
    "微波": ["微波"],
}
...
MAIN_INGREDIENT_GROUPS: dict[str, list[str]] = {
    "鸡肉": ["鸡", "鸡腿", "鸡翅", "鸡胸", "鸡爪", "鸡丁", "鸡丝", "鸡块", "鸡蛋", "鸡蛋液", "蛋液", "蛋黄", "蛋白"],
    "猪肉": ["猪", "五花肉", "里脊", "排骨", "猪蹄", "肘子", "肉末", "肉糜", "肉馅", "肉丝", "肉片", "培根"],
    "牛肉": ["牛腩", "牛肉", "牛排", "牛里脊", "肥牛"],
    "羊肉": ["羊排", "羊肉", "羊腩"],
    "鱼虾": ["鱼", "虾", "蟹", "鳝", "鳗", "鲍鱼", "海参", "生蚝", "蛏", "蛤", "鲈", "鲤", "鲢", "鳜", "翘嘴", "田螺", "小龙虾", "罗氏虾"],
    "蛋奶": ["鸡蛋", "牛奶", "奶酪", "芝士", "黄油", "酸奶", "奶油"],
    ...
    "饮品原料": ["茶", "咖啡", "可可", "椰浆", "椰奶", "酒酿", "醪糟", "可乐", "雪碧"],
